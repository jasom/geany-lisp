...
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o completions.o completions.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o definitions.o definitions.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o indent.o indent.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o plugin-main.o plugin-main.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o project.o project.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o repl.o repl.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o server.o server.c
$CONFIG_CC $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -c -o util.o util.c
$CONFIG_CC -shared $CONFIG_CFLAGS -Wall -Wextra -Werror -Wno-error=deprecated-declarations -fPIC $CONFIG_GEANY_CFLAGS -o glisp.so completions.o definitions.o indent.o plugin-main.o project.o repl.o server.o util.o
